                            ...
                            <div class="cover-body d-flex justify-content-between align-items-center">
                                ...
                                <?php if ($data_user[$i]['id_user'] == $_SESSION['id']) { ?>
                                    ...
                                    <div class="d-none d-md-block">
                                        <a href="?controller=users&action=edit&id=<?php echo $data_user[$i]['id_user'] ?>" class="btn btn-primary btn-icon-text btn-edit-profile">
                        ...
                        for ($j = 0; $j < count($post_id); $j++) { ?>
                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="card rounded">
                                    ...
                                    <?php
                                    $pos = new Post;
                                    $likes = $pos->get_like_by_post($post_id[$j]['id_post']);
                                    ?>

                                    <p class="px-3"><?php echo (count($likes) != 0) ? count($likes) . ' likes!' : ''; ?></p>
                                    <div class="card-footer">
                                        <div class="d-flex post-actions">

                                            <a href="?controller=pages&action=likes&id_post=<?php echo $post_id[$j]['id_post']; ?>" class=" d-flex align-items-center text-muted mr-4">
