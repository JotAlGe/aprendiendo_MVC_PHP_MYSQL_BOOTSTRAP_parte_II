            ...
            <div class="col-lg-12">
                <div class="text-center">
                    <ul class="col container-filter portfolioFilte list-unstyled mb-0" id="filter">
                        ...
                        <li><a class="categories" data-filter=".branding" href="index.php?controller=users&action=index&id=<?php echo $galery[0]['id_user'] ?>">Ir a <?php echo $galery[0]['name_user'] ?></a></li>
